"""detecting_side_effects URL Configuration
...
from detecting_side_effects import settings
...
urlpatterns = [
    ...
    url(r'^Find_Drug_Reactions_Type/$', remoteuser.Find_Drug_Reactions_Type, name="Find_Drug_Reactions_Type"),
    ...
    url(r'^View_Detected_Drug_Reactions_Type_Ratio/$', serviceprovider.View_Detected_Drug_Reactions_Type_Ratio, name="View_Detected_Drug_Reactions_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Detected_Drug_Reactions_Type/$', serviceprovider.View_Detected_Drug_Reactions_Type, name="View_Detected_Drug_Reactions_Type"),
