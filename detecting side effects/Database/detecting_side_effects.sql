...
--
-- Host: localhost
-- Generation Time: Jan 20, 2025 at 12:05 PM
...
--
-- Database: `detecting_side_effects`
--
CREATE DATABASE IF NOT EXISTS `detecting_side_effects` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detecting_side_effects`;
...
('08uv9gw38j1udt7727nwig0kb5ezs38x', 'eyJ1c2VyaWQiOjF9:1snyWn:r6mtALLodMRXvs1g4zz1vDBIBNzwTtffvnQAuIlBo1o', '2024-09-24 10:55:21.854475'),
...
('be612m0ehhyzsq9ncfn7svkmzwgmzf69', 'eyJ1c2VyaWQiOjJ9:1snzfR:IwKAlDv9z97d2q-zo2sfKc0J3SVPzRH6XDnCHJukQfI', '2024-09-24 12:08:21.134105'),
...
('p2nri8kl5hxka24wtvzzsgkm1kq1k0m0', 'eyJ1c2VyaWQiOjJ9:1oaECU:U_1mvxldQ25XYbAtjpbE3dVbxylctBx0ixOMhSA9QV0', '2022-10-03 10:40:30.479640'),
...
('zu8vxpwpm842cwx3bhydj8scdw4flxgi', 'eyJ1c2VyaWQiOjF9:1oaDfy:K3cPHvmVhEcdPQSoBM-sBtPnv6BAsG6X5oUmFAxuDEA', '2022-10-03 10:06:54.799907');
...
(1, 'Gopinath', 'Gopinath123@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th cross,Vijayanagar', 'Male'),
...
(34, 'Graph Neural Network (GNN)', '47.43083003952569'),
(35, 'SVM', '41.50197628458498'),
(36, 'Logistic Regression', '43.08300395256917'),
(37, 'Decision Tree Classifier', '44.26877470355731'),
(38, 'KNeighborsClassifier', '49.40711462450593');
...
(12, 'Found More Side Effects', '50.0'),
(13, 'No Side Effects', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detect_drug_reactions`
--

CREATE TABLE IF NOT EXISTS `remote_user_detect_drug_reactions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `Drug_Name1` varchar(300) NOT NULL,
  `Reason1` varchar(300) NOT NULL,
  `Drug_Name2` varchar(300) NOT NULL,
  `Reason2` varchar(300) NOT NULL,
  `Rating` varchar(300) NOT NULL,
  `Reviews` varchar(300) NOT NULL,
  `Drugfollowers` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9 ;

--
-- Dumping data for table `remote_user_detect_drug_reactions`
--

INSERT INTO `remote_user_detect_drug_reactions` (`id`, `Fid`, `Drug_Name1`, `Reason1`, `Drug_Name2`, `Reason2`, `Rating`, `Reviews`, `Drugfollowers`, `Prediction`) VALUES
(1, '10.42.0.42-66.198.24.224-41089-443-6', 'Acnay Gel 10gm', 'Acne', 'Irban 5mg Tablet 10''SIrban 7.5mg Tablet 10''S', 'Angina', '9', '34', '2291', 'No Side Effects'),
(2, '10.42.0.151-31.13.71.3-43132-443-6', 'Acne Aid Bar 50gmAcne Aid Bar 100gm', 'Acne', 'Isbid 20mg Tablet 10''SIsbid 10mg Tablet 10''S', 'Angina', '2', '34', '286', 'Found More Side Effects'),
(3, '174.35.73.149-10.42.0.211-80-59292-6', 'Acne UV Gel 60gm', 'Acne', 'Iski 30mg Tablet 10''SIski 60mg Tablet 10''S', 'Angina', '1', '73', '29', 'Found More Side Effects'),
(4, '10.42.0.211-10.42.0.1-54385-53-17', 'Acnelak Soap 75gm', 'Acne', 'Isocor 20mg Tablet 10''S', 'Angina', '4', '8', '29', 'Found More Side Effects'),
(5, '172.217.10.238-10.42.0.211-80-43477-6', 'Acnewar Plus Gel 15gm', 'Acne', 'Ivamac 5mg Tablet 10''S', 'Angina', '2', '33', '1213', 'No Side Effects'),
(6, '10.42.0.211-67.129.144.48-52713-80-6', 'Acnedap Gel 15gm', 'Acne', 'Ismo Retard 40mg Tablet 7''S', 'Angina', '5', '26', '29', 'No Side Effects'),
(7, '182.22.25.252-10.42.0.211-443-38342-6', 'Acnedap Plus Gel 15gm', 'Acne', 'Ismorin 60/75mg Capsule 10''S', 'Angina', '1', '15', '29', 'Found More Side Effects'),
(8, '10.42.0.42-54.239.17.112-52579-443-6', 'Brevoxyl Creamy Wash Lotion 50gm', 'Acne', 'Nitrocontin 6.4mg Tablet 25''SNitrocontin 6.4mg Tablet 30''SNitrocontin 2.6mg Tablet 25''SNitrocontin 2.6mg Tablet 30''S', 'Angina', '3', '15', '143', 'No Side Effects');
